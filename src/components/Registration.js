    ...
    <>
      ...
      <div className="container registration">
        ...
        <p className="main-p">
          ...
          <a title="Requirements" style={{padding: '0 0 0 5px'}} href="https://github.com/imconfde/8br-requirements">ссылке</a>. 
          Объем материалов доклада – не более двух страниц. Материалы доклада должны быть подготовлены в LaTEX и представлены в форматах <b>tex</b> и <b>pdf</b>.
