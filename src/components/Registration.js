  ...
  return (
    <>
      ...
      <div className="container registration">
        ...
        <p className="main-p"><a title="Requirements english" href="https://github.com/imconfde/8br-req-rus-dos" target="_blank" rel="noopener noreferrer">Example.tex</a> – на английском языке.</p>
        <p className="main-p">
          Доклады следует присылать на электронный адрес ??? до <b className="deadline">1 октября 2025 года</b>. Оргкомитет конференции оставляет за собой 
