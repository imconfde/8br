    ...
    <>
      ...
      <div className="container registration">
        ...
        <p className="main-p">
          ...
          <a title="Requirements" style={{padding: '0 0 0 5px'}} href="//https://github.com/imconfde/8br/requirements">ссылке</a>. Оргкомитет конференции оставляет за собой право отклонить материалы, 
