    ...
    <>
      ...
      <div className="container about">
        ...
        <div>
          ...
          <p className="main-p">Регистрация – до 1 октября 2025 г.</p>
          <p className="main-p">Подача материалов доклада – до 15 октября 2025 г.</p>
          <p className="main-p">Работа конференции – 2-5 декабря 2025 г.</p>
        </div>
      </div>
    </>
  );
